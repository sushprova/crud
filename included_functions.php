...
<?php
	...
	function new_header($name="Sushmita Prova Halder", $urlLink="") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~sphalder/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";	
	...
	function new_footer($name="Sushmita Prova Halder"){
